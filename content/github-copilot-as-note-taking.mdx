...
Wow. [GitHub Copilot](https://copilot.github.com/) has stunned me - and the
world with its AI-enhanced auto-complete prowess. As of writing, its
predecessors [Kite](https://kite.com) and other predecessors cannot compete with
it in creativity, accuracy, or strength.

I noticed its prowess particularly when taking notes at school. For example,

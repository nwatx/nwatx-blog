---
title: A Guide to the UIL computer science Exam
description: Covers many aspects of the UIL CS Exam from bit operations to data structures.
...
<Warning title="This article is a work in progress" description="test" />

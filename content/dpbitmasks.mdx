...
We can check whether or not the $k$-th bit is set by using $S \& (1 \ll (k-1))$. Another equivalent operation is $(n \gg (k-1))\& 1$. You can read more about how this works [here](https://www.geeksforgeeks.org/check-whether-k-th-bit-set-not/).

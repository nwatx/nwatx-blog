export const h1 = ({...rest}) => {
    return <p className='text-4xl dark:text-gray-100' {...rest}/>
}

export const h2 = ({...rest}) => {
    return <p className='text-3xl underline dark:text-gray-100' {...rest}/>
}

export const h3 = ({...rest}) => {
    return <p className='text-md text-gray-500 dark:text-gray-300' {...rest} />
}
...
export const blockquote = ({...rest}) => {
    return <div className="w-full mx-auto rounded-lg p-1 text-gray-800 dark:Text-gray-100 justify-center">
        <div className="w-full mb-10">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300 font-medium text-center px-5" {...rest}/>

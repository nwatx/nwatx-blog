...
// 	return (
// 		<h1
// 			className="text-3xl mt-7 mb-3 font-semibold dark:text-gray-100"
// 			{...rest}
// 		/>
// 	);
// };
...
// 	return (
// 		<h2
// 			className="text-2xl mt-7 mb-3 font-semibold dark:text-gray-100"
// 			{...rest}
// 		/>
// 	);
// };
...
// 	return (
// 		<h3
// 			className="text-xl mt-7 mb-3 font-semibold dark:text-gray-100"
// 			{...rest}
// 		/>
// 	);
// };
...
// 	return (
// 		<ol className="my-4 space-y-4 border-l-4 px-4 border-blue-600" {...rest} />
// 	);
// };
...
// 	// console.log(rest);
// 	return (
// 		<code className="font-semibold dark:text-blue-400" {...rest}>
// 			`{children}`
// 		</code>
// 	);
// };

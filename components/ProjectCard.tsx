...
export default function ProjectCard({ title, description, href }) {
  return (
    <Link href={href} passHref={true}>
      <div className="flex w-full my-1 flex-col lg:flex-row hover:shadow-inner dark:hover:bg-gray-700 cursor-pointer items-center border border-gray-200 dark:border-gray-600 rounded-lg p-4">
